...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/dashboard-nvim"
  },
  ["galaxyline.nvim"] = {
    loaded = true,
  ...
  ["lightspeed.nvim"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/lightspeed.nvim"
  },
  ["material.nvim"] = {
    loaded = true,
  ...
  ["nvcode-color-schemes.vim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/opt/nvcode-color-schemes.vim"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
  ...
  ["nvim-compe"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/nvim-tree.lua"
  },
  ["nvim-treesitter"] = {
    loaded = true,
  ...
  ["nvim-whichkey-setup.lua"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/nvim-whichkey-setup.lua"
  },
  ["orgmode.nvim"] = {
    loaded = true,
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/tokyonight.nvim"
  },
  ["vim-fugitive"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/vim-fugitive"
  },
  ["vim-which-key"] = {
    loaded = true,
    path = "/home/pgrogan/.local/share/nvim/site/pack/packer/start/vim-which-key"
  }
}
